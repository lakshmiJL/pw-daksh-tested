...
export default function OrdersScreen({route,navigation}){
                ...
                {text:'Cancel',style:'cancel'},
                {
                    ...
                    onPress:async()=>{
                        try{
                            ...
                            Alert.alerrt('Order Rejected','The order has been cancelled');
                        } catch(error){
    ...
    const handleUpdateStatus=async (orderId,newStatus)=>{
        try{
            ...
            if(newStatus==='ready') updateData.readyAt=newDate();
                ...
                >
                    ...
                    {filterCounts[item.id]>0 &&(
                        <View style={styles.filterBadge}>
                            <Text stylele={styles.filterBadgeText}>{filterCounts[item.id]}</Text>
                        </View>
                    )}
                </TouchableOpacity>
            )}
